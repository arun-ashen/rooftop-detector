...
def load_unet_model():
    ...
    # 1. FIX FOR PYTORCH 2.6+: Tell PyTorch to trust these classes
    ...
    # 2. DEFINE THE "BODY" (Architecture)
    # This creates the 'model' variable so the NameError disappears
    model = smp.Unet(
    ...
    try:
        ...
        if isinstance(checkpoint, dict):
            ...
            # If the file is the full model object, we use it directly
            model = checkpoint
