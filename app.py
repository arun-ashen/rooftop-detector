...
def load_unet_model():
    ...
    file_id = '1Fzop__8OnJuF8Vxhp6dv4igAVM54ekRc' 
    url = f'https://drive.google.com/uc?id={file_id}'

    # Download the model from Drive if it's not already there
    if not os.path.exists(model_path):
        with st.spinner("Downloading model from Drive... this only happens once."):
